...
if len(sys.argv) <= 1:
    ...
    for linha in data:
        ...
        tempoMedioResposta.append(float(linha.split(' ')[1])) 
        # tempoMedioResposta.append(float(linha.split(' ')[5])) # Para gerar grafico do Simulador

    problema2File.close()
    mtp.scatter(taxaChegadaMedia, tempoMedioResposta)
